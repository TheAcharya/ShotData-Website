...
![Create Configuration for Roles](/assets/pd-reviewing-roles-01.gif)
...
3. Switch to `Manual` [Export Mode](/user-guide/general/#export-mode) so [Roles](/user-guide/roles) stays open while you review.
