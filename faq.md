...
**Shot Data** facilitates extraction from any conceivable timeline such as Projects and Compound Clips.

## Why is there no Workflow Extension for Shot Data?

Incorporating a Final Cut Pro Workflow Extension into **Shot Data** would not, in practice, unlock any meaningfully new capability for spreadsheet generation. There are two principal reasons for this decision.
